...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/HALKKAT/LB_Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL" , "https://t.me/animendanimeonly")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/mrmikeysupport")
